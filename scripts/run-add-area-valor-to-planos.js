...
async function main() {
  ...
  try {
    console.log('Ejecutando migración: agregando columnas area_m2 y valor a planos si no existen...')
    await sql`
      ALTER TABLE planos
        ADD COLUMN IF NOT EXISTS area_m2 DECIMAL(10,2) NOT NULL DEFAULT 0,
